...
namespace GoogleDriveUploader.View
{
    public partial class GoogleDriveExample : Form
    {
        ...
        private void ClickUpdateButton(object sender, EventArgs e)
        {
            ...
            List < Google.Apis.Drive.v2.Data.File > _fileListBox = _service.ListRootFileAndFolder();
            Google.Apis.Drive.v2.Data.File foundFile = _fileListBox.Find(
                item =>
                {
                    return item.Title == FILE_TITLE_ON_DRIVE;
                }
            );
        ...
        private void ClickDeleteButton(object sender, EventArgs e)
        {
            ...
            Google.Apis.Drive.v2.Data.File foundFile = fileList.Find(
                item =>
                {
                    return item.Title == DELETE_FILE_ON_DRIVE_NAME;
                }
            );
